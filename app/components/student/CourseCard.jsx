...
const CourseCard = ({course }) => {
  ...
  return (
    <Link  href={'pages/student/courselist/'+ course._id } onClick={()=> scrollTo(0,0)} className=' border border-gray-500/30 pb-6 overflow-hidden rounded-lg hover:shadow-2xl'>
